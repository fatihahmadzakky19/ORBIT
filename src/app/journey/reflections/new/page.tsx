...
export default function NewReflectionPage() {
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-200 max-w-4xl mx-auto">
      ...
      {/* Header */}
      <div>
        <h1 className="text-xl md:text-2xl font-semibold text-main">Weekly Reflection</h1>
      ...
      <div className="p-5 rounded-xl bg-surface border border-line">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-center">
          ...
          <div className="p-3 rounded-lg bg-canvas border border-border-subtle">
            ...
            <div className="text-[11px] text-dim mt-0.5">Habits Days</div>
          </div>
          <div className="p-3 rounded-lg bg-canvas border border-border-subtle">
            <div className="text-base font-mono font-semibold text-main">3</div>
            <div className="text-[11px] text-dim mt-0.5">Active Goals</div>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSave} className="p-6 rounded-xl bg-surface border border-line space-y-6">
        <div>
          ...
          <p className="text-[11px] text-dim mb-2">
            What did you actually do this week? Key events, progress, or setbacks.
          </p>
          <textarea
            required
            rows={4}
            placeholder="This week I worked on my portfolio and started applying for frontend jobs..."
            value={whatHappened}
        ...
        <div>
          ...
          <p className="text-[11px] text-dim mb-2">
            Key insights, takeaways, skills, or realizations from your activities.
          </p>
          <textarea
            required
            rows={4}
            placeholder="I learned more about array transformations and avoiding manual loops..."
            value={whatLearned}
        ...
        <div>
          ...
          <p className="text-[11px] text-dim mb-2">
            How has your perspective, confidence, habit rhythm, or direction shifted?
          </p>
          <textarea
            required
            rows={4}
            placeholder="I feel more confident about building UIs without looking up tutorials every step..."
            value={whatChanged}
