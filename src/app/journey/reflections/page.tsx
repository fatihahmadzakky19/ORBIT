  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-xl font-semibold text-main">Reflections</h1>
          <p className="text-xs text-dim mt-0.5">
            Weekly archives documenting what actually happened, what you learned, and how you changed.
          </p>
        </div>
        <Link
            ...
            <div className="flex items-start justify-between mb-2">
              <div>
                <div className="flex items-center gap-2">
                  <span className="text-sm font-semibold text-main">{ref.weekLabel}</span>
